...
class MarkdownGenerator:
    ...
    def generate_main_file(
        ...
        # Table of contents
        lines.extend(self._generate_toc(pages_data))

        # Summary
        lines.extend(self._generate_summary(pages_data))
    ...
    def _generate_toc(self, pages_data: List[PageData]) -> List[str]:
        ...
        return [
            "\n## Table of Contents\n",
            "- [Introduction](./docs/complete_content.md)\n",
            "- [Summary](#summary)\n",
            "- [Images](#images)\n",
            "- [Edge Text](#edge-text)\n",
        ]

    def _generate_summary(self, pages_data: List[PageData]) -> List[str]:
