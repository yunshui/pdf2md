...
- [x] 章节边界检测改进（更多模式、结构分析、布局变化检测）
- [x] 复杂布局文本排序改进（区域感知、重叠检测、说明文字识别）
...
| 2026-04-23 | 章节边界检测改进：更多模式（附录、摘要等） | 检测能力 |
| 2026-04-23 | 章节边界检测改进：页面顶部位置检测（前20%） | 检测精度 |
| 2026-04-23 | 章节边界检测改进：字体大小对比（1.3x中位数） | 检测精度 |
| 2026-04-23 | 章节边界检测改进：布局变化检测（栏数、尺寸） | 检测能力 |
| 2026-04-23 | 章节边界检测改进：文本密度变化检测 | 检测能力 |
| 2026-04-23 | Mock 布局类增强：添加 text_density、body_regions 等属性 | 测试兼容性 |
| 2026-04-23 | 复杂布局文本排序：区域感知排序（主体、侧边栏） | 排序能力 |
| 2026-04-23 | 复杂布局文本排序：重叠元素检测和处理 | 排序能力 |
| 2026-04-23 | 复杂布局文本排序：说明文字识别（图表、标注） | 识别能力 |
| 2026-04-23 | 复杂布局文本排序：标准排序方法（Y优先，X次优先） | 代码质量 |
| 2026-04-24 | 版本更新：0.1.0 → 0.1.1 | 版本管理 |
| 2026-04-24 | 打包配置：更新 pyproject.toml（版本、依赖、URL、关键词） | 打包配置 |
| 2026-04-24 | 打包配置：添加项目 URL（主页、文档、仓库、问题追踪） | 打包配置 |
| 2026-04-24 | 打包配置：更新开发状态（Alpha → Beta） | 打包配置 |
| 2026-04-24 | 包构建：成功构建 pdf2md-0.1.1.tar.gz 和 pdf2md-0.1.1-py3-none-any.whl | 打包发布 |
